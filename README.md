...
Все четыре файла имеют один источник и обновляются одновременно каждый час.
...
Запуск проверки задержки до серверов в подписке отличается в разных клиентах, но в каком-либо виде он должен быть обязательно: URL Test, Latency Test и тому подобные. После окончания проверки вы получите список доступных серверов с указанной задержкой. Подключитесь к подходящему для вас — и вы получите доступ к интернету.
